...
import 'package:flutter_themoviedb/domain/api_client/auth_api_client.dart';
...
class AuthAutorizedState extends AuthState {
  ...
  bool operator ==(Object other) =>
      ...
      other is AuthAutorizedState && runtimeType == other.runtimeType;

  @override
  int get hashCode => 0;
}

/// Состояние, когда не авторизован
class AuthNotAutorizedState extends AuthState {
  @override
  bool operator ==(Object other) =>
      other is AuthNotAutorizedState && runtimeType == other.runtimeType;
...
/// Состояние, когда авторизация в прогрессе
...
/// Состояние проверки статуса
class AuthCheckStatusProgressState extends AuthState {
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is AuthCheckStatusProgressState && runtimeType == other.runtimeType;
