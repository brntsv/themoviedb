...
part of 'serial_details.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

SerialDetails _$SerialDetailsFromJson(Map<String, dynamic> json) =>
    SerialDetails(
      ...
      credits:
          SerialDetaisCredits.fromJson(json['credits'] as Map<String, dynamic>),
      videos:
          DetailsTrailerVideo.fromJson(json['videos'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$SerialDetailsToJson(SerialDetails instance) =>
    <String, dynamic>{
